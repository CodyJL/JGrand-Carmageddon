...
Trains[TrackNumber]['Trains'][i] = exports.JStreamer2:JcreateObject('tram',x,y,z,0,0,0) -- Create cart at track subset.
Trains[TrackNumber]['Doors'][i] = {}
Trains[TrackNumber]['Doors'][i][1] = exports.JStreamer2:JcreateObject('tramd',x,y,z,0,0,0) -- Create Door #1
Trains[TrackNumber]['Doors'][i][2] = exports.JStreamer2:JcreateObject('tramd',x,y,z,0,0,0) -- Create Door #2
